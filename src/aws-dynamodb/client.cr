...
module Aws::DynamoDB
  class Client
    ...
    def list_tables(**params)
      response = http.post("/", body: params.to_json, op: "ListTables")
    ...
    def batch_get_item(**params)
      response = http.post("/", body: params.to_json, op: "BatchGetItem")
      Types::BatchGetItemOutput.from_json(response.body)
    end

    def update_item(**params)
      response = http.post("/", body: params.to_json, op: "UpdateItem")
      Types::UpdateItemOutput.from_json(response.body)
    end

    def query(**params)
      response = http.post("/", body: params.to_json, op: "Query")
      Types::QueryOutput.from_json(response.body)
    end

    def delete_item(**params)
      response = http.post("/", body: params.to_json, op: "DeleteItem")
